    ...
    <>
      ...
      <div className="container flex items-center justify-center mx-auto my-8">
        <button
          ...
          type="button"
          data-modal-toggle="session_type-modal"
        >
          Añadir nuevo tipo de sesión
        </button>

        <div
          id="session_type-modal"
          tabIndex="-1"
          aria-hidden="true"
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              >
                <h3 className="text-xl font-medium text-gray-900 dark:text-white">
                  Introduce los datos del tipo de sesión:
                </h3>
                <div>
                ...
                <button
                  ...
                  onClick={() => {
                    fetch(process.env.BACKEND_URL + "/api/sessions_type", {
                      method: "POST",
                      headers: {
