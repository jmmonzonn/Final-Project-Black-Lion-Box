...
export const TermsAndConditions = () => {
  return (
    <div className="w-screen h-screen">
      <div className="patternBg dark:patternBgD border-L-Gray-dark border-opacity-30 dark:border-D-Gray-light dark:border-opacity-10 rounded-lg border py-8 px-4 mx-8">
        <div className="container mx-auto text-center ">
          <div className="p-1 h-auto w-auto bg-L-Gray-light rounded-lg border shadow-md sm:p-1 dark:bg-D-Gray-dark dark:border-gray-700">
            <div className="grid grid-cols-1 px-20">
              <p className="font-bellfort text-center font-bold text-xl text-L-Gray-dark dark:text-D-Gray-light border-b-2 border-A-Magenta dark:border-M-Lime py-2">
                POLÍTICA DE PRIVACIDAD{" "}
              </p>
              <br />
              <p className="px-6 py-4 text-center dark:text-D-Gray-light">
                El presente Política de Privacidad establece los términos en que
                usa y protege la información que es proporcionada por sus
                ...
                de correo electrónica e información demográfica. <br />
                <br />
                ...
                facturación. Uso de la información recogida Nuestro sitio web
                emplea la información con el fin de proporcionar el mejor
                ...
                cancelados en cualquier momento. está altamente comprometido
                ...
                autorizado. Cookies Una cookie se refiere a un fichero que es
                enviado con la finalidad de solicitar permiso para almacenarse
                en su ordenador, al aceptar dicho fichero se crea y la cookie
                sirve entonces para tener información respecto al tráfico web, y
                también facilita las futuras recurrente. Otra función que tienen
                ...
                pueda utilizar algunos de nuestros servicios. Enlaces a Terceros
                ...
                sus datos en esos otros sitios terceros. <br />
                <br />
                Dichos sitios están sujetos a sus propias políticas de
                privacidad por lo cual es recomendable que los consulte para
                confirmar que usted está de acuerdo con estas. Control de su
                información personal En cualquier momento usted puede restringir
                la recopilación o el uso de la información personal que es
                proporcionada a nuestro sitio web. Cada vez que se le solicite
                rellenar un formulario, como el de alta de usuario, puede marcar
                o desmarcar la opción de recibir información por correo
                ...
                salvo que sea requerido por un juez con un orden judicial. Se
