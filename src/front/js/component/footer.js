...
export const Footer = () => (
  <footer className=" sticky p-4 L-Gray-light shadow md:flex md:items-center md:justify-between md:p-6 bg-L-Gray-light dark:bg-D-Gray-dark bottom-0 left-0 w-full">
