...
export const Navbar = () => {
  ...
  return (
    <nav class="bg-L-Gray-light">
      <div class="container flex items-center justify-center px-6 py-8 mx-auto text-L-Gray-dark capitalize">
        <img src={isolight} className="mr-3 h-16 sm:h-9" alt="Big Lion Box" />
        <a
          href="#"
          className="border-b-2 border-transparent hover: text-A-Magenta hover:border-M-Lime mx-1.5 sm:mx-6"
        >
          home
        </a>
