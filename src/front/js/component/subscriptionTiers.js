    ...
    <div className="container mx-auto" id="Suscripciones">
      <div className="grid grid-cols-4 gap-4">
        {store.suscriptionList.map((value, index) => {
          return (
            <div
              className="p-1 h-70 bg-L-Gray-light rounded-lg border shadow-md sm:p-1 dark:bg-D-Gray-dark dark:border-gray-700 hover:bg-M-Lime dark:hover:bg-D-Gray-med"
              key={index}
            >
              {/* Nombre de la sesión */}
